...
func Test_deduceVariables(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "only value type",
			...
			args: args{
				desiredVars: []*VariableObject{&VariableObject{Name: "age", VariableType: REF_PRE_CI, Format: NUMBER, ReferenceVariableName: "age", ReferenceVariableStepIndex: 1},
					&VariableObject{Name: "name", VariableType: REF_PRE_CI, Format: STRING, ReferenceVariableName: "my-name", ReferenceVariableStepIndex: 1},
					&VariableObject{Name: "status", VariableType: REF_PRE_CI, Format: BOOL, ReferenceVariableName: "status", ReferenceVariableStepIndex: 1}},
			...
			wantErr: false,
			want: []*VariableObject{&VariableObject{Name: "age", VariableType: REF_PRE_CI, Format: NUMBER, ReferenceVariableName: "age", Value: "20", TypedValue: float64(20), ReferenceVariableStepIndex: 1},
				&VariableObject{Name: "name", VariableType: REF_PRE_CI, Format: STRING, ReferenceVariableName: "my-name", Value: "test", TypedValue: "test", ReferenceVariableStepIndex: 1},
				&VariableObject{Name: "status", VariableType: REF_PRE_CI, Format: BOOL, ReferenceVariableName: "status", Value: "true", TypedValue: true, ReferenceVariableStepIndex: 1}},
		}, {name: "REF_POST_CI",
			args: args{
