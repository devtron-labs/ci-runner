...
RUN apk update && apk add --no-cache --virtual .build-deps && apk add bash && apk add make && apk add curl && apk add openssh=9.3_p1-r4 && apk add git && apk add zip && apk add jq
