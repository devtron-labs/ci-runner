...
func main() {
	...
	//args := `{"type":"CI","ciRequest":{"workflowNamePrefix":"21-ci-33-pitp-7","pipelineName":"ci-33-pitp","pipelineId":7,"dockerImageTag":"c3b18ccd-7-21","dockerRegistryId":"gireesh-test","dockerRegistryType":"docker-hub","dockerRegistryURL":"docker.io","dockerConnection":"","dockerCert":"","dockerRepository":"gireeshnaidu/kuchbhi","checkoutPath":"","dockerUsername":"gireeshnaidu","dockerPassword":"Gireesh@2k","awsRegion":"","accessKey":"","secretKey":"","ciCacheLocation":"","ciCacheRegion":"","ciCacheFileName":"ci-33-pitp-7.tar.gz","ciProjectDetails":[{"gitRepository":"https://github.com/devtron-labs/devtron.git","materialName":"1-devtron","checkoutPath":"./","fetchSubmodules":false,"commitHash":"c3b18ccd9db26c69bea9a79974dd160ffb03a088","gitTag":"","commitTime":"2023-08-03T10:52:45Z","type":"SOURCE_TYPE_BRANCH_FIXED","message":"feat:sql script file added for Approval node notification  (#3725)\n\n* devtronContainerImageRepo varilable added\r\n\r\n* sql file added","author":"Aditya Ranjan \u003c91401966+adi6859@users.noreply.github.com\u003e","gitOptions":{"userName":"","password":"","sshPrivateKey":"","accessToken":"","authMode":"ANONYMOUS"},"sourceType":"SOURCE_TYPE_BRANCH_FIXED","sourceValue":"main","WebhookData":{"Id":0,"EventActionType":"","Data":null}}],"containerResources":{"minCpu":"","maxCpu":"","minStorage":"","maxStorage":"","minEphStorage":"","maxEphStorage":"","minMem":"","maxMem":""},"activeDeadlineSeconds":3600,"ciImage":"quay.io/devtron/ci-runner:37b94b38-138-14234","namespace":"devtron-ci","workflowId":21,"triggeredBy":2,"cacheLimit":5000000000,"beforeDockerBuildScripts":null,"afterDockerBuildScripts":null,"ciArtifactLocation":"","ciArtifactBucket":"","ciArtifactFileName":"","ciArtifactRegion":"","scanEnabled":false,"cloudProvider":"","blobStorageConfigured":false,"blobStorageS3Config":null,"azureBlobConfig":null,"gcpBlobConfig":null,"blobStorageLogsKey":"devtron/21-ci-33-pitp-7","inAppLoggingEnabled":false,"defaultAddressPoolBaseCidr":"","defaultAddressPoolSize":0,"preCiSteps":null,"postCiSteps":null,"refPlugins":null,"appName":"gireesh-test","triggerByAuthor":"admin","ciBuildConfig":{"id":4,"buildContextGitMaterialId":4,"useRootBuildContext":true,"ciBuildType":"self-dockerfile-build","dockerBuildConfig":{"dockerfileRelativePath":"Dockerfile","dockerfileContent":"","buildContext":".","useBuildx":false,"useBuildxK8sDriver":true,"buildxK8SDriverOptions":[{"deploymentName":"builder-amd64","namespace":"devtron-ci","nodeSelector":""},{"deploymentName":"builder-amd64-test","namespace":"devtron-ci","nodeSelector":""}]},"buildPackConfig":null},"ciBuildDockerMtuValue":-1,"ignoreDockerCachePush":false,"ignoreDockerCachePull":false,"cacheInvalidate":false,"IsPvcMounted":false,"extraEnvironmentVariables":{},"enableBuildContext":true,"appId":33,"environmentId":0,"orchestratorHost":"http://devtroncd-orchestrator-service-prod.devtroncd/webhook/msg/nats","orchestratorToken":"b1MvQm5STGZpbW1VL2NkeEpoWER2YmtSQ3M0PQo","isExtRun":false,"imageRetryCount":0,"imageRetryInterval":5},"cdRequest":null}`
	LoggingMode := "RunMode"
	if len(os.Args) > 1 {
